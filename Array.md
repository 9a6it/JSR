...
####  [**:top:**](#book--array) `join()`
Возвращает строку, объединив все элементы массива (или массивоподобного объекта) в одну строку, разделив указанным символом. Любой элемент массива, который имеет значение `undefined` или `null`, будет преобразован в пустую строку.
```js
const arr = [1, 2, 3, 4, 5];
